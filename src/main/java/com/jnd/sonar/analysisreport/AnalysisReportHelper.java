		...
		private void sendEmail(String reportname, Map<String, String> reportDataMap2)
		{
			try {
			  ...
			  System.out.println("Analysis -  Sonar Email Notification");
	  		  String from = settings.getString("sonar.jd.smptp.username");
	  		  System.out.println("from=>"+from);
	  		  String to_email = settings.getString("sonar.jd.smptp.to");
	  		  System.out.println("to_email=>"+to_email);
	  		  
	  		  String to_email_name = settings.getString("sonar.jd.smptp.to_name");
	  		  System.out.println("to_email_name=>"+to_email_name);
	  		
	  		  String username = settings.getString("sonar.jd.smptp.username");
	  		  System.out.println("username=>"+username);
	  		  String password = settings.getString("sonar.jd.smptp.password");
	  		  System.out.println("password=>"+password);
			  String hostname = settings.getString("sonar.jd.smptp.host");
			  System.out.println("hostname=>"+hostname);
			  String portno = settings.getString("sonar.jd.smptp.sslport");
			  System.out.println("portno=>"+portno);
			  boolean setSSLOnConnectFlag = settings.getBoolean("sonar.jd.smptp.set_ssl_on_connect");
			  System.out.println("setSSLOnConnectFlag=>"+String.valueOf(setSSLOnConnectFlag));
			  String subject = settings.getString("sonar.jd.smptp.subject");
			  System.out.println("subject=>"+subject);
			  String message = settings.getString("sonar.jd.smptp.message");
